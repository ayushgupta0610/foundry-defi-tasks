...
contract DefiPositionsTest is Test {
    ...
    // (TODO: IMPORTANT) Check if the contract is following CEI pattern
    // (TODO: IMPORTANT) Check for the specific assets that can be deposited in the pool
    function testLeveragedLong() external returns (uint256 totalCollateralBase, uint256 totalDebtBase, uint256 availableBorrowsBase) {
        ...
        // TODO: Has to be done outside the contract (aapproving this contract to spend the user's asset)
        vm.prank(alice);
        ...
        // TODO: How to get the creditDelegationToken address?
        vm.prank(alice);
